...
public class EnumConverterConfiguration {
    ...
    @Bean(name = "org.openapitools.configuration.EnumConverterConfiguration.databaseVariantConverter")
    Converter<String, DatabaseVariant> databaseVariantConverter() {
        return new Converter<String, DatabaseVariant>() {
            @Override
